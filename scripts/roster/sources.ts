 ...
 * (its "API" tab). Not discoverable by title search through either the Provider Data Catalog
 * metastore or the general data.json catalog, so the UUID is hardcoded rather than resolved
 * dynamically (mirrors the same constant in src/data/sources.ts).
 */
export const CMS_POS_HOSPITAL_DATASET_UUID = '8ba0f9b4-9493-4aa0-9f82-44ea9468d1b5'

export const CENSUS_GEOCODE_BATCH_URL = 'https://geocoding.geo.census.gov/geocoder/locations/addressbatch'
